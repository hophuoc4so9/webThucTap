...
def build_job_extraction_prompt(job: dict) -> tuple[str, str]:
    system_prompt = (
        "You are a recruitment AI. Extract key information from the job posting."
        " Return ONLY one valid JSON object matching the schema. Use concise Vietnamese."
    )
