...
import { CandidateSearchPage } from "@/features/company/pages/CandidateSearchPage/index";
...
import { SkillManagerPage } from "@/features/admin/pages/SkillManagerPage";
...
export const router = createBrowserRouter([
  ...
  // Company Routes
  {
    ...
    children: [
      ...
      { path: "candidate-search", element: <CandidateSearchPage /> },
      {
        path: "candidates",
  ...
  // Admin Routes
  {
    ...
    children: [
      ...
      { path: "skills/dashboard", element: <Navigate to="/admin/market-trends" replace /> },
      { path: "skills/manager", element: <SkillManagerPage /> },
