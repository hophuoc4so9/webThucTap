          ...
          <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-sm space-y-4">
            ...
            <div className="flex justify-end gap-3">
              <button
                ...
                className="px-4 py-2 border rounded-lg text-sm hover:bg-gray-50 transition-colors text-black"
              >
                Hủy
              </button>
              <button
            ...
            <div className="flex flex-col gap-2">
              {roleOptions.map((r) => (
                <button
                  ...
                  className="px-4 py-2 border border-gray-300 rounded-lg text-sm hover:bg-blue-50 disabled:opacity-60 transition-colors text-left text-black"
                >
                  {ROLE_LABELS[r]}
                </button>
              ))}
