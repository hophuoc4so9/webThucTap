        ...
        <div className="flex-1 flex items-stretch bg-[#f0f4f8]">
          <div className="w-full h-full flex flex-col justify-center bg-[#f8fafc] p-8 lg:p-16 relative">
            ...
            <form onSubmit={handleRegister} className="max-w-md w-full mx-auto">
              ...
              <div className="mb-6 p-4 bg-blue-50 border border-blue-100 rounded-xl text-xs text-blue-700 leading-relaxed">
                <p className="font-bold mb-1">💡 Lưu ý về loại tài khoản:</p>
                <ul className="list-disc ml-4 space-y-1">
                  <li><strong>Sinh viên TDMU:</strong> Sử dụng email <code>@student.tdmu.edu.vn</code> để được tự động xác thực và nhận huy hiệu ưu tiên.</li>
                  <li><strong>Sinh viên trường khác:</strong> Có thể sử dụng email cá nhân, tài khoản sẽ cần xác thực qua mã OTP.</li>
                </ul>
              </div>
