                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-2 mt-0.5">
                      ...
                      {job.aiAnalysisStatus === "pending" && (
                        <div className="flex items-center gap-1 text-[10px] text-blue-500 font-medium">
                          <Loader2 size={10} className="animate-spin" />
                          AI đang phân tích...
                        </div>
                      )}
                      {job.aiAnalysisStatus === "succeeded" && (
                        <div className="flex items-center gap-1 text-[10px] text-purple-500 font-bold" title="Đã trích xuất yêu cầu bằng AI">
                          <Sparkles size={10} />
                          AI Verified
                        </div>
                      )}
