...
export class CompanyController {
  ...
  @MessagePattern("company_mark_all_notifications_read")
  markAllNotificationsRead(@Payload() payload: { userId?: number }) {
    return this.companyService.markAllNotificationsRead(payload?.userId);
  }
}
