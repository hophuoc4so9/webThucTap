...
export class Job {
  ...
  /** Đánh dấu là tin thực tập */
  @Column({ name: "is_internship", default: false })
  isInternship: boolean;

  /** Đánh dấu dành cho sinh viên mới tốt nghiệp */
  @Column({ name: "is_fresher", default: false })
  isFresher: boolean;

  /** Thời gian thực tập (vd: 3 tháng, 6 tháng) */
  @Column({ name: "internship_duration", nullable: true })
  internshipDuration: string;

  /** Phụ cấp thực tập (nếu có) */
  @Column({ name: "internship_allowance", nullable: true })
  internshipAllowance: string;

  /** Có người hướng dẫn (Mentor) không */
  @Column({ name: "has_mentor", default: false })
  hasMentor: boolean;

  /** Lộ trình đào tạo / Những gì sẽ học được */
  @Column({ name: "training_program", type: "text", nullable: true })
  trainingProgram: string;

  /** Thời gian linh hoạt cho sinh viên */
  @Column({ name: "flexible_hours", default: false })
  ...
  @Column({ name: "ai_analysis_task_id", type: "text", nullable: true })
  aiAnalysisTaskId: string | null;

  @Column({ name: "ai_analysis_status", type: "text", nullable: true, default: "none" })
  aiAnalysisStatus: string | null; // none, pending, succeeded, failed
