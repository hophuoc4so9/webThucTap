...
export class AiSearchController {
  ...
  async handleAdvancedSearch(
    ...
    console.log("RMQ MESSAGE RECEIVED: ai_search_advanced_search");
  ...
  /**
   * RMQ pattern: ai_search_search_candidates
   */
  @MessagePattern("ai_search_search_candidates")
  async handleSearchCandidates(@Payload() query: any) {
